...
import test
# import test modules
from test import test_client, test_explore, test_inverted_geocoding, test_journeys, test_route_schedules, test_raw
...
suite.addTests(loader.loadTestsFromModule(test_raw))
